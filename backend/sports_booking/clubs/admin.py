...
class SportsClubAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        # prefetch_related('reviews') so average_rating/total_reviews in
        # list_display don't hit the DB twice per row (was up to 100 extra
        # queries on a full 50-row admin page).
